...
Tags built by CI:
- ghcr.io/killerking93/transformers-textengine-openapi:latest-with-model-cpu
- ghcr.io/killerking93/transformers-textengine-openapi:latest-with-model-nvidia
- ghcr.io/killerking93/transformers-textengine-openapi:latest-with-model-amd

Pull:

```bash
# CPU
docker pull ghcr.io/killerking93/transformers-textengine-openapi:latest-with-model-cpu

# NVIDIA (CUDA 12.4 wheel)
docker pull ghcr.io/killerking93/transformers-textengine-openapi:latest-with-model-nvidia

# AMD (ROCm 6.2 wheel)
docker pull ghcr.io/killerking93/transformers-textengine-openapi:latest-with-model-amd
```
...
services:
  - type: web
    ...
    env: docker
    image:
      url: ghcr.io/killerking93/transformers-textengine-openapi:latest-with-model-cpu
    plan: standard
    region: oregon
